	...
	<div>
		<div class="flex items-center shrink-0 p-4 pb-0">
			...
			<div class="w-full p-2">
				<textarea v-model="text" :placeholder="props.placeholder" class="w-full h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0 dark:text-white focus:ring-0"></textarea>
			</div>
		</div>
		...
		<div class="flex p-2 pl-14">
			<div class="flex w-full">
				<!-- Image frame Icon -->
				<div class="p-2 text-blue-400 rounded-full cursor-pointer hover:bg-blue-50 dark:bg-dim-800" @click="handleImageClick">
				...
				<div class="p-2 text-blue-400 rounded-full cursor-pointer hover:bg-blue-50 dark:bg-dim-800">
					<!-- Gif Icon -->
					<svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
						<g>
							<path
			...
			<div>
				<UIButton @click="handFormSubmit" size="sm" :disabled="isDisabled">Tweet</UIButton>
			</div>
		</div>
	</div>
</template>
